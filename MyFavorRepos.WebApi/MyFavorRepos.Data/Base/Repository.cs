...
using MyFavorRepos.Data.DataAccess;
...
{
    public class Repository : IServiceRepository, IDataRepository, IDisposable
    {
        ...
        protected Repository(string conn = "", DatabaseType databaseType = DatabaseType.MySql)
        {
